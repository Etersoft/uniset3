...
namespace uniset3
{
    ...
    */
    ...
    {
        public:
            OPCUAExchange( uniset3::ObjectId id, uniset3::ObjectId icID, const std::shared_ptr<SharedMemory>& shm = nullptr, const std::string& prefix = "opcua" );
        ...
        protected:
            ...
            virtual void timerInfo( const uniset3::umessage::TimerMessage* sm ) override;
            ...
            struct Channel
            {
                ...
                uniset3::Trigger trStatus;
                uniset3::PassiveTimer ptTimeout;
            ...
            uniset3::Trigger noConnections;
            std::atomic_uint32_t currentChannel = { 0 };

            uniset3::timeout_t reconnectPause = { 10000 };
            int filtersize = { 0 };
            float filterT = { 0.0 };
