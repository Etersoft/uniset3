...
class UModbus(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _UModbus.UModbus_swiginit(self, _UModbus.new_UModbus())
...
# Register UModbus in _UModbus:
_UModbus.UModbus_swigregister(UModbus)
