...
namespace uniset3
{
    ...
    ) noexcept
    {
        ...
        auto* monitoredItem = static_cast<uniset3::MonitoredItem*>(monContext);
...
std::vector<opcua::MonitoredItem<opcua::Client>> OPCUAClient::subscribeDataChanges(
            ...
            std::vector<uniset3::DataChangeCallback>& dataChangeCallbacks,
            std::vector<uniset3::DeleteMonitoredItemCallback>& deleteMonItemCallbacks,
        ...
        )
{
    ...
    std::vector<std::unique_ptr<uniset3::MonitoredItem>> monItems;
    ...
    for( size_t i = 0 ; i < attr_size ; i++ )
    {
        ...
        auto context = std::make_unique<uniset3::MonitoredItem>();
