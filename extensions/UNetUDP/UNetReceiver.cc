...
namespace uniset3
{
    ...
    // -----------------------------------------------------------------------------
    void UNetReceiver::setModeID( uniset3::ObjectId id ) noexcept
    {
        sidMode = id;
...
namespace std
{
    std::string to_string( const uniset3::UNetReceiver::Mode& m )
    {
        if( m == uniset3::UNetReceiver::Mode::mEnabled )
            return "Enabled";

        if( m == uniset3::UNetReceiver::Mode::mDisabled )
            return "Disabled";
