 ...
 */
// --------------------------------------------------------------------------
#ifndef ConfiguratorProxy_H_
#define ConfiguratorProxy_H_
// --------------------------------------------------------------------------
#include <memory>
#include <atomic>
...
namespace uniset3
{
    ...
    //-------------------------------------------------------------------------
    /*! Реализует grpc-интерфейс Configurator_i и проксирует запросы к дочерним объектам по svcId
