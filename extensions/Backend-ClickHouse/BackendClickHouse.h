...
namespace uniset3
{
    ...
    */
    ...
    {
        public:
            BackendClickHouse( uniset3::ObjectId objId, xmlNode* cnode, uniset3::ObjectId shmID, const std::shared_ptr<SharedMemory>& ic = nullptr,
        ...
        protected:
            ...
            std::unordered_map<uniset3::ObjectId, ParamInfo> clickhouseParams;
            TagList globalTags;
            ...
            std::unique_ptr<uniset3::ClickHouseTagsConfig> dyntags;
