...
namespace uniset3
{
    ...
    */
    ...
    {
        public:
            OPCUAServer(uniset3::ObjectId objId, xmlNode* cnode, uniset3::ObjectId shmID,
        ...
        protected:
            ...
            struct IOVariable
            {
                ...
                uniset3::IOType stype = { uniset3::AO };
            ...
            struct IOMethod
            {
                IOMethod( uniset3::ObjectId _sid) : sid(_sid) {};

                IOController::IOStateList::iterator it;
                uniset3::ObjectId sid = { DefaultObjectId };
                uint8_t precision = { 0 }; // only for float
            };
        ...
        private:
            ...
            uniset3::timeout_t updateTime_msec = { 100 };
            ...
            void initFolderMap( uniset3::UniXML::iterator it, const std::string& parent_name, std::unique_ptr<IONode>& parent );
    };
    // --------------------------------------------------------------------------
